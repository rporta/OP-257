...
class GetCampaignsInfoOpratel
{
        ...
        do {
            ...
            if ($page->getEntries() !== null) {
                ...
                foreach ($page->getEntries() as $campaign) {
                    ...
                    $rta[$rtaI]["id"] = $campaign->getId();
                    $rta[$rtaI]["name"] = $campaign->getName();
                    $rta[$rtaI]["status"] = $campaign->getStatus();
    ...
    public static function main($ClientCustomerId = "713-824-1599", $setSelector = null)
    {
        ...
        return self::runExample(new AdWordsServices(), $session, $setSelector);
    }
}
...
// GetCampaignsInfoOpratel::main($ClientCustomerId, $setSelector);
